...
if (getCookie("cookiesAccepted") != "true"){
	...
	Event.observe(window, 'load', function() {
		...
		cookie_container.insert (cookie_moreinfo);
  		...
  		eprints.currentRepository().phrase ({'cookies_action_accept': {}, 'cookies_action_decline': {}, 'cookies_help': {}, 'cookies_moreinfo': {}, 'cookies_redirect': {}, 'cookies_moreinfo_a': {}}, function(phrases) {
